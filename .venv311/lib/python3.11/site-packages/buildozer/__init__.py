...
try:
    ...
    # Older/newer Python may not expose FancyURLopener; provide a minimal
    # compatible fallback that exposes `retrieve()` so code that subclasses
    # FancyURLopener (ChromeDownloader below) continues to work.
    from urllib.request import urlopen
    import shutil

    class FancyURLopener:
        def __init__(self, *args, **kwargs):
            # allow subclasses to override `version` attribute
            self.version = None
        ...
        def retrieve(self, url, filename=None):
            ...
            # no filename requested — consume response and return placeholder
            resp.read()
            return (None, None)
