# --- Jurnal Saham IHSG - App Shell / Wrapper (v2 with AI Tab) ---
# File: app/main_app.py
# Purpose: Main entry point and UI Shell with 6 tabs including AI
# LOGIC ASLI 100% DARI desktop_app_bak.py
...
class AppShell(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # Initialize tabs (LOGIC ASLI 100%)
        self.tabs = [
            WatchlistTab(),
            DashboardTab(),
            JurnalTab(),
    ...
    def switch_tab(self, idx):
        """Switch ke tab dengan index (LOGIC ASLI)"""
...
class StockJournalApp(App):
    def build(self):
        ...
        if Window.size[0] > Window.size[1]: Window.size = (380, 720)
        return AppShell()
